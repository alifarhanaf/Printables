...
<form action="{{ route('submit.faqs') }}" method="POST" enctype="multipart/form-data">
    {{ csrf_field() }}
...
<button type="submit" style="width: fit-content;" class="mg-t-20 btn btn-az-primary pd-x-20">Publish Brand</button> --}}
          ...
          <div class="d-flex flex-column wd-md-100% pd-30 pd-sm-40 bg-gray-200">
            ...
            <div class="form-group">
              <input name="questions" type="text" class="form-control" placeholder="Enter Question">
            </div>

            <label class="form-label mg-b-10 pd-l-5"><b>Enter Answers:</b></label>
            <div class="form-group row row-sm  mg-b-10">
              <div class="col-lg">
                <textarea id="editor" name="answers" rows="6" class="form-control" placeholder="Enter Answers"></textarea>
              </div>
          </div>
