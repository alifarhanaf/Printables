    ...
    <div class="row">
        <div class="col-md-9 ">
            <div class="az-content-label mg-b-5 ">
              ...
              @else
              <p class="pd-t-10">Enter New category</p>
              @endif
...
<div class="row">
    <div class="col-md-9 mg-t-15">
        ...
        <div class="d-flex flex-column wd-md-100% pd-30 pd-sm-40 bg-gray-200">
            <label class="form-label mg-b-10 pd-l-5"><b>Enter Category Name:</b></label>
        ...
        <div class="card bd-0">
            ...
            <div class="card-body bd bd-t-0">
                <div style="margin-left: 8%">
                    <div class="row"><input style="margin-top: 2%" type="radio" name="status" value="1" @if (isset($category))
                    ...
                    <div class="row"><input style="margin-top: 2%" type="radio" name="status" value="0" @if (isset($category))
