...
<section class="header_beneath">
    <div class="container" >
                ...
                <div class="main_under_product_spacing">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 col-10 m-auto d-block">
                            <div class="my_main_product_text" data-toggle="modal" data-target="#exampleModal{{$product->id}}">
        ...
        <div class="modal fade image_model" id="exampleModal{{$product->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">{{$product->name}} {{$product->categories[0]->name}}</h5>
                            ...
                            <div class="selected_image">
                              ...
                              <div class="slected_image">
                                <div class="image_select_spacing">
                                  <img src="{{ $design[0]->images[0]->url}}" class="img-fluid" alt="">
                                </div>
                              </div>
