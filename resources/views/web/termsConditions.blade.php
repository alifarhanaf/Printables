...
<p>
You agree to indemnify, defend and hold harmless College Thread and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.
...
<p>
These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of 66 Cleary Ct. San Francisco California US 94109.
<br>
</p>
...
<h5 class="TandS" >
SECTION 20 - Refunds, Returns & Exchanges
</h5>
 
<h5 class="TandS" >
SECTION 20.1 - Store Purchases
</h5>
 
<h5 class="TandS" >
SECTION 20.1.1 - FOR CAMPAIGN (PRE-ORDER) ITEMS
</h5>
 
<p>
Once a campaign has ended, ALL SALES ARE FINAL. NO REFUNDS OR EXCHANGES. Campaign items are made to order, and as such we do not produce extras, we do not carry excess inventory, we do not offer exchanges, and we do not accept returns of any kind.
<br>
</p>
 
<h5 class="TandS" >
SECTION 20.1.2 - FOR NON-CAMPAIGN (RETAIL) ITEMS
</h5>
...
<h5 class="TandS" >
SECTION 20.1.3 - FOR SPECIALTY CUSTOM "MADE TO ORDER" ITEMS
</h5>
<p>
 

​Made to Order items include but are not limited to Vintage Signs, Custom Jewelry, Boyfriend Flannels, and Custom Pattern Snapbacks. These items are customized just for you and are produced specifically for your order only. For this reason, we cannot accept returns on custom made to order items. ALL SALES ARE FINAL. NO REFUNDS OR EXCHANGES.
<br>
</p>
<h5 class="TandS" >
SECTION 20.1.4 - ORDER CANCELLATION
</h5>
 
<p>
​To provide you with the fastest service possible, once a custom order is in production, it cannot be canceled. We cannot make any changes or cancellations to any order once it is placed. Individual orders cannot be canceled once they enter our shipping process. For individual order, once you receive your package you can choose to exchange it in accordance with the above return policy.
<br>
</p>
 
<h5 class="TandS" >
SECTION 20.1.5 - FOR DAMAGED ITEMS
</h5>
...
<h5 class="TandS" >
SECTION 20.2.1 - RETURN POLICY FOR CUSTOM ORDERS
</h5>
