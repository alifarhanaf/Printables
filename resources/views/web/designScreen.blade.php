                                ...
                                <button type="button" class="designInfo" data-toggle="modal" data-id="{{$design->id}}" data-target="#exampleModal{{$design->id}}">
                                        ...
                                        <div class="popup_header">
                                            <div class="img_parent">
                                                <img src="{{ asset($design->images[0]->url)}}" alt="" class="img-fluid">
                                            </div>
                                        </div>
                                </button>
        ...
        {{-- End Modal --}}
                ...
                <div class="my_all_content">
                    <div class="my_flex_main">
                        ...
                        <div class="flex_child">
                            <div class="chlidren_spacing">
                            <button type="button" class="designInfo" data-toggle="modal" data-id="{{$recent->id}}" data-target="#exampleRecentModal{{$recent->id}}">
                                
                                    <div class="popup_header">
                                        <div class="img_parent">
                                            <img src="{{ asset($recent->images[0]->url)}}" alt="" class="img-fluid">
                                        </div>
                                    </div>
                            </button>
...
<div class="modal fade" id="exampleRecentModal{{$recent->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered model_custom_width">
        <div class="modal-content">
        <div class="modal-body my_custom_model">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6 col-12 d-block mx-auto">
                    <div class="model_main_section_textt">
                        ...
                        <div class="button_model_collection">
                            <form action="{{ route('setCookie') }}" method="POST" >
                                <input type="hidden" id="designID" name="designID" value="{{$recent->id}}">
                                <button type="submit" style="border:none;">
                            <a  class="btn my-btn w-100">
