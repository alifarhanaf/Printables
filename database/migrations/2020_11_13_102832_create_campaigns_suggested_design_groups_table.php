...
class CreateCampaignsSuggestedDesignGroupsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('campaigns_suggested_design_groups', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('campaigns_suggested_design_groups');
    }
}
